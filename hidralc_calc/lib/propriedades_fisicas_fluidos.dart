      ...
      children: [
        Card(
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => PropriedadesDaAgua()));
          },
        ...
        Card(
          ...
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => DensidadesRelativasUsuais()));
          },
            ...
            child: TextButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TensaoSuperficialUsual()));
                },
        ...
        Card(
            child: TextButton(
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Capilaridade()));
                },
